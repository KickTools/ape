        ...
        <section className="flex flex-col items-center justify-center py-12 px-6 max-w-4xl mx-auto">
            ...
            <div className="w-full space-y-8">
                ...
                <section className="section-privacy">
                    ...
                    <p>
                        For privacy-related concerns or questions, you can contact us through Discord at <Link isExternal showAnchorIcon href="https://kicktools.app/discord" className="accent text-secondary-600">KickTools Discord</Link> or via email at <Link isExternal showAnchorIcon anchorIcon={<EmailIcon />} href="mailto:support@kicktools.app" className="accent text-secondary-600">support@kicktools.app</Link>.
                    </p>
                </section>
